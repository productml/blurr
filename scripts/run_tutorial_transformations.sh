...
# Use this script to run the tutorial transformations under examples/tutorial
...
pipenv run python -m blurr transform \
    --streaming-dtc=${TUTORIAL_PATH}/streaming-dtc.yml \
    --window-dtc=${TUTORIAL_PATH}/window-dtc.yml \
