...
class WindowAggregateSchema(AggregateSchema):
    ...
    def __init__(self, fully_qualified_name: str, schema_loader: SchemaLoader) -> None:
        ...
        if not self.errors:
            self.window_value = self.spec[self.ATTRIBUTE_WINDOW_VALUE]
            self.window_type = self.spec[self.ATTRIBUTE_WINDOW_TYPE]
            self.source = self.schema_loader.get_schema_object(self.spec[self.ATTRIBUTE_SOURCE])
