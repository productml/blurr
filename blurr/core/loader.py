...
ITEM_MAP = {
        ...
        'Blurr:DataGroup:AnchorAggregate': 'blurr.core.anchor_data_group.AnchorDataGroup',
...
SCHEMA_MAP = {
        ...
        'Blurr:DataGroup:AnchorAggregate': 'blurr.core.anchor_data_group.AnchorDataGroupSchema',
